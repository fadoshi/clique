...
<head>
  ...
  <title>Index- Clique</title>
  <meta name="description" content="">
  <meta name="keywords" content="">

  <!-- Favicons -->
  <link href="{{ asset('active/img/favicon.png') }}" rel="icon">
  ...
  <!-- Vendor CSS Files -->
  <link href="{{ asset('active/vendor/bootstrap/css/bootstrap.min.css') }}" rel="stylesheet">
  <link href="{{ asset('active/vendor/bootstrap-icons/bootstrap-icons.css') }}" rel="stylesheet">
  <link href="{{ asset('active/vendor/aos/aos.css') }}" rel="stylesheet">
  <link href="{{ asset('active/vendor/swiper/swiper-bundle.min.css') }}" rel="stylesheet">
  <link href="{{ asset('active/vendor/glightbox/css/glightbox.min.css') }}" rel="stylesheet">

  <!-- Main CSS File -->
  <link href="{{ asset('active/css/main.css') }}" rel="stylesheet">
...
<body class="index-page">
            ...
            <div class="swiper init-swiper">
              ...
              <div class="swiper-wrapper">
                <div class="swiper-slide">
                  <img src="{{asset('active/img/img_h_6.jpg') }}" alt="Image" class="img-fluid">
                </div>
              </div>
          ...
          <div class="row justify-content-center">
            <div class="col-sm-12 col-md-5 col-lg-4 col-xl-4 order-lg-2 offset-xl-1 mb-4">
              <div class="img-wrap text-center text-md-left" data-aos="fade-up" data-aos-delay="100">
                <div class="img">
                  <img src="{{ asset('active/img/img_v_3.jpg') }}" alt="circle image" class="img-fluid">
                </div>
              </div>
            </div>
        ...
        <div class="row gy-4 justify-content-center">
          ...
          <div class="col-lg-5">
            <div class="images-overlap">
              <img src="{{ asset('active/img/img_v_1.jpg') }}" alt="student" class="img-fluid img-1" data-aos="fade-up">
            </div>
          </div>
  ...
  <!-- Vendor JS Files -->
  <script src="{{ asset('active/vendor/bootstrap/js/bootstrap.bundle.min.js') }}"></script>
  <script src="{{ asset('active/vendor/aos/aos.js') }}"></script>
  <script src="{{ asset('active/vendor/swiper/swiper-bundle.min.js') }}"></script>
  <script src="{{ asset('active/vendor/purecounter/purecounter_vanilla.js') }}"></script>
  <script src="{{ asset('active/vendor/glightbox/js/glightbox.min.js') }}"></script>
  <script src="{{ asset('active/vendor/imagesloaded/imagesloaded.pkgd.min.js') }}"></script>
  <script src="{{ asset('active/vendor/isotope-layout/isotope.pkgd.min.js') }}"></script>

  <!-- Main JS File -->
  <script src="{{ asset('active/js/main.js')}}"></script>
